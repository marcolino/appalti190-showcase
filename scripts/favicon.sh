...
$CONVERT_CMD $PWD/favicon-256.png -resize 192x192 $PWD/favicon-192.png
...
$CONVERT_CMD $PWD/favicon-16.png $PWD/favicon-32.png $PWD/favicon-64.png -colors 256 $PWD/favicon.ico
